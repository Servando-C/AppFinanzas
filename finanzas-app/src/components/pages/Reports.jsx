...
export default function Reports() {
  ...
  useEffect(() => {
    ...
    fetch(`http://127.0.0.1:5000/api/reportes/empresas/${form.empresa_id}/proyectos`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    if (form.empresa_id && form.proyecto_id) {
      ...
      fetch(`http://127.0.0.1:5000/api/reportes/tesoreria/fechas/${form.empresa_id}/${form.proyecto_id}`)
        .then((res) => res.json())
        .then((data) => {
  ...
  const handleDownloadPdf = () => {
    ...
    const reportUrl = `http://127.0.0.1:5000/api/reportes/balance-general/pdf?empresa_id=${form.empresa_id}&proyecto_id=${form.proyecto_id}&fecha_hasta=${selectedFecha}`;
